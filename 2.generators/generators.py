"""Generator is a function, we can stop and start several times and it returns an iterator"""
...
"""As you can see above, the mygenerator function uses the yield keyword. 
The generator is called just like a normal function. 
However, its execution is paused on encountering the yield keyword. 
This sends the first value of the iterator stream to the calling environment. 
